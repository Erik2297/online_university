                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            <h1>ՀԵՏԱՔՐՔԻՐ <span id="js-rotating">ՈՒՍՈՒՑՈՒՄ, ԱՇԽԱՏԱՆՔ, ԺԱՄԱՆՑ</span></h1>
                            <p class="p-heading p-large">Կայքը հնարավորություն կտա թե՛ ուսանողներին, թե՛ դասախոսներին առցանց տարբերակով անցկացնել իրենց ուսումնական պրոցեսը։ Հարգելի ուսանողներ այլևս չեք մոռանա ստուգարքային գրքույկը տանը, որովհետև այն հասանելի է արդեն առցանց ։</p>
                            <a class="btn-solid-lg page-scroll text-uppercase" href="#intro"> ստուգարքային գրքույկ </a>
                        </div>
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
